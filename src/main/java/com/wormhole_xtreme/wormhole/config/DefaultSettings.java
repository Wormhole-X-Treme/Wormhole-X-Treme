...
public class DefaultSettings 
{
    ...
    final static Setting[] config = {
        ...
        new Setting(
                    ConfigKeys.PERMISSIONS_SUPPORT_DISABLE,
                    false,
                    "If set to true, Permissions plugin will not be attached to evem if available.",
                    "WormholeXTreme"
        ),
        new Setting(
        ...
        new Setting(
                    ConfigKeys.ICONOMY_SUPPORT_DISABLE,
                    false,
                    "If set to true, iConomy plugin will not be attached to even if available.",
                    "WormholeXTreme"
        ),
        new Setting(
        ...
        new Setting(
                    ConfigKeys.HELP_SUPPORT_DISABLE,
                    false,
                    "If set to true, Help plugin will not be attached to even if available.",
                    "WormholeXTreme"
        ),
        new Setting(
